...
Este documento visa replicar as análises do livro do Djalma Pessoa [link](https://djalmapessoa.github.io/adac/introduc.html#tab:numset) e também como material de estudo dos métodos e recursos computacionais para análise de dados amostrais complexos, principalmente das pesquisas do IBGE.
...
Os autores adicionam 14 variáveis derivadas das variáveis existentes do conjunto de dados.
...
variáveis a serem utilizadas, probs, estratos, vari´aives, fpc, pesos).
